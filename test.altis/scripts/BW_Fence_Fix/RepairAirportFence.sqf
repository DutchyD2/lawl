...
//Options:
_MarkerName = "Fence"; // The centre of the area to be affected.
...
_replacement = createVehicle [_ReplaceType, [_pos select 0, _pos select 1, _pos select 2], [], 0, "CAN_COLLIDE"]; // < Replacement Classname
