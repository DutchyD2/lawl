...
_Admins = ["76561198095188672","76561198089488318","76561197971238176","76561198089191999"]; 			//Add your admin UID here
...
if(isDedicated) then {
	...
	[] spawn {
		while{true} do {
			...
			((findDisplay 49) displayCtrl 103) ctrlEnable false; // I like tits
			((findDisplay 49) displayCtrl 103) ctrlSetText "Team-Atomic"; // Opz is gay
			((findDisplay 49) displayCtrl 122) ctrlEnable false; //uwut bruv
...
_exists = loadFile "Admin\AdminMenu.sqf";
if(_exists != "") then {
	call compile preprocessfilelinenumbers "Admin\AdminMenu.sqf";
};