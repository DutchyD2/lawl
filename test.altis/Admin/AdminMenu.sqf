...
Admin_List = compileFinal "['76561198095188672','76561198089488318','76561197971238176','76561198089191999','_SP_PLAYER_']";		//replace these with your admin player UIDS (steamID64)
...
if(!isDedicated) then {
	if(player call AH_AdminCheck) then {
		...
		hint parseText format["Press '%1' to open the admin menu!<br/>Press '%2' to open the spawn menu!<br/>Press F1 F2 and F3 to delete and repair vehicles or open the log menu respectively",(actionKeysNames ["User1",1]),(actionKeysNames ["User2",1])];
	};
};
