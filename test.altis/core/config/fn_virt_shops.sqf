...
switch (_shop) do
{
	case "market": {["Altis Market",["water","rabbit","apple","redgull","tbacon","lockpick","pickaxe","fuelF","peach","boltcutter","storagesmall","storagebig","honey"]]};
	...
	case "heroin": {["Drug Dealer",["cocainep","heroinp","marijuana","crackp"]]};
