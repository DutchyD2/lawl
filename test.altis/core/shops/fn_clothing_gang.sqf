...
//Shop Title Name
ctrlSetText[3103,"Gang Clothing Shop"];
...
switch (_filter) do
{
	...
	case 1:
	{
		[
			...
			["H_PilotHelmetHeli_O",nil,15000],
			["H_HelmetCrew_O",nil,15000]
		];
	};
