	class playerHUD
   	{
		...
		class controlsBackground 
		{
            ...
            class happyHIcon : life_RscPicture 
            {
                               
		        idc = -1;
			    text = "icons\smiley.paa";
			    x = safeZoneX+safeZoneW-0.11; y = safeZoneY+safeZoneH-0.40; //change Y Coordinate
			    w = 0.02; h = 0.03;
            };
		};
